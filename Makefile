...
help:
	...
	@echo ""
	@echo "SPRÁVA VM:"
	@echo "  make start               - Zapnout VM"
	@echo "  make stop                - Korektně vypnout VM (shutdown)"
	@echo "  make reboot              - Restartovat VM"
	...
	@echo ""
	@echo "MAZÁNÍ:"
	@echo "  make remove              - Odstranit VM (disk zůstane)"
	@echo "  make clean               - Smazat disk $(DISK_PATH)"
	@echo "  make reinstall           - Úplný reinstall (VM + disk + nová instalace)"
	@echo "  make purge               - Kompletní vymazání (VM + disk + unattended ISO)"
	@echo ""
	@echo "CURRENT CONFIG: vCPU=$(VCPU), RAM=$(RAM_MB)MB, DISK=$(DISK_GB)GB"
	@echo ""
	@echo "RYCHLÝ START:"
	@echo "  1. make download-virtio"
	@echo "  2. make download-ws-iso"
	@echo "  3. make install"
